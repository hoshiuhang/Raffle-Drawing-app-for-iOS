...
//    Create new raffle
    ...
    func insert(raffle: Raffle)
    {
        let insertStatementQuery =
            "INSERT INTO raffle (title, price, max_ticket, max_player, prize) VALUES (?, ?, ?, ?, ?);"
...
//
    ...
    {
        var result = [Raffle]()
        let selectStatementQuery = "SELECT id,title,price,max_ticket,max_player,prize FROM raffle "
